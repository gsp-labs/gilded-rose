...
describe("Gilded Rose", () => {
  it("should lower sellIn value by 1 at the end of day", () => {
    const gildedRose = new GildedRose([
      { categoryName: "+5 Dexterity Vest", quality: 20, sellIn: 10 },
    ]);
  ...
  it("should lower quality value by 2 once the sll by date has passed", () => {
    const gildedRose = new GildedRose([
      { categoryName: "+5 Dexterity Vest", quality: 20, sellIn: 0 },
    ]);
    gildedRose.updateQuality();
  ...
  it("should NOT lower quality when it approaches zero", () => {
    const gildedRose = new GildedRose([
      { categoryName: "+5 Dexterity Vest", quality: 0, sellIn: 0 },
    ]);
    gildedRose.updateQuality();
    expect(gildedRose.items[0].sellIn).toBe(-1);
  ...
  it("should increase quality of Aged Brie by 1 at the end of day", () => {
    const gildedRose = new GildedRose([
      { categoryName: "Aged Brie", quality: 20, sellIn: 10 },
    ]);
    gildedRose.updateQuality();
    expect(gildedRose.items[0].sellIn).toBe(9);
  ...
  it("should NOT increase quality above 50", () => {
    const gildedRose = new GildedRose([
      { categoryName: "Aged Brie", quality: 50, sellIn: 10 },
    ]);
    gildedRose.updateQuality();
    expect(gildedRose.items[0].sellIn).toBe(9);
  ...
  it("should not update quality or sellIn value for Sulfuras, Hand of Ragnaros", () => {
    const gildedRose = new GildedRose([
      { categoryName: "Sulfuras, Hand of Ragnaros", quality: 20, sellIn: 10 },
    ]);
    gildedRose.updateQuality();
  ...
  it("should update the quality of all the items", () => {
    const gildedRose = new GildedRose([
      ...
      {
        categoryName: "Sulfuras, Hand of Ragnaros",
        quality: 15,
        sellIn: 3,
      },
      {
        categoryName: "+5 Dexterity Vest",
        quality: 4,
        sellIn: 0,
      },
      {
